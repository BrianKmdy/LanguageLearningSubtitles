...
sys.path.append(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'subtitles'))
...
@pytest.fixture
def _subtitle_file():
    subtitle_file = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'test_data', 'test.srt')
